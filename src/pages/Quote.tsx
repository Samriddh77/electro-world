...
export default function Quote() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Rate limiting: prevent submissions within 10 seconds of each other
    const now = Date.now();
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        <section className="lg:col-span-4 space-y-12">
          <div className="space-y-4">
            ...
            <h1 className="text-5xl font-black text-primary tracking-tighter leading-none">Precise Pricing for Industrial Projects.</h1>
          ...
          <div className="bg-surface-container p-8 space-y-8 rounded-sm">
            <div className="flex items-center gap-4">
              <div className="bg-primary-container text-on-primary w-12 h-12 flex items-center justify-center rounded-sm">
            ...
            <div className="pt-8 border-t border-outline-variant/30 space-y-6">
              ...
              <a className="group flex items-center justify-between hover:bg-white p-3 -mx-3 transition-colors duration-200" href="tel:9826037055">
                <div className="flex items-center gap-4">
              ...
              <a className="group flex items-center justify-between hover:bg-white p-3 -mx-3 transition-colors duration-200" href="https://wa.me/919826037055" target="_blank" rel="noopener noreferrer">
                <div className="flex items-center gap-4">
          ...
          <div className="relative aspect-video bg-surface-container overflow-hidden rounded-sm">
            <img 
        ...
        <section className="lg:col-span-8 bg-surface-container-lowest p-8 lg:p-12 shadow-[0_12px_32px_rgba(26,28,28,0.06)] border border-outline-variant/20">
          <form className="space-y-10" onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
              ...
              <div className="md:col-span-2 space-y-4">
                ...
                <label className="border-2 border-dashed border-outline-variant/50 p-8 text-center bg-surface-container-low/50 hover:bg-surface-container-low transition-colors group cursor-pointer block">
                  <input type="file" className="hidden" />
                  <CloudUpload className="w-12 h-12 mx-auto text-outline-variant group-hover:text-primary transition-colors" />
            ...
            <div className="pt-6">
              <button disabled={loading} className="w-full md:w-auto bg-gradient-to-br from-primary to-primary-container text-on-primary px-12 py-4 font-black uppercase tracking-[0.2em] text-sm hover:scale-95 duration-150 ease-in-out flex items-center justify-center gap-2" type="submit">
