  ...
  return (
    <div className="max-w-7xl mx-auto px-8 py-16">
      ...
      <div className="mb-20">
        ...
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-primary leading-none mb-6 uppercase">CONNECT WITH AUTHORITY.</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Direct Calls */}
          <div className="bg-surface-container-lowest p-8 flex flex-col justify-between group transition-all duration-300 hover:bg-primary-container hover:text-white">
            <div>
              <Phone className="w-8 h-8 text-primary mb-6 group-hover:text-white" />
              <h3 className="text-xl font-bold mb-2">Priority Sales Lines</h3>
              <p className="text-sm text-on-surface-variant group-hover:text-white/70 mb-8">Click to dial our authorized representatives</p>
            </div>
            <div className="space-y-4">
              <a className="flex items-center justify-between font-bold border-b border-outline-variant pb-2 group-hover:border-white/20" href="tel:9826037055">
                <span>9826037055</span>
                <ArrowUpRight className="w-4 h-4" />
              </a>
              <a className="flex items-center justify-between font-bold border-b border-outline-variant pb-2 group-hover:border-white/20" href="tel:9826037056">
                <span>9826037056</span>
                <ArrowUpRight className="w-4 h-4" />
              </a>
              <a className="flex items-center justify-between font-bold border-b border-outline-variant pb-2 group-hover:border-white/20" href="tel:0731245678">
          ...
          {/* WhatsApp Enquiry */}
          <div className="bg-secondary-container p-8 flex flex-col justify-between text-on-secondary-container">
            <div>
              <MessageSquare className="w-8 h-8 mb-6" />
              <h3 className="text-xl font-bold mb-2">WhatsApp Direct</h3>
              <p className="text-sm opacity-80 mb-8">Send technical specs or product images for instant quotes.</p>
            </div>
          ...
          {/* Office Address */}
          <div className="bg-surface-container p-8 md:col-span-2">
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-sm uppercase tracking-widest font-bold text-on-surface-variant mb-4">Indore Headquarters</h3>
                <p className="text-xl font-bold leading-tight mb-4">
                  New Siyaganj, Indore,<br />Madhya Pradesh, 452007
                </p>
                <p className="text-on-surface-variant text-sm mb-6">Authorized distribution hub for central India.</p>
              ...
              <div className="flex flex-col justify-end">
                <h3 className="text-sm uppercase tracking-widest font-bold text-on-surface-variant mb-4">Business Hours</h3>
          ...
          {/* Map Placeholder */}
          <div className="md:col-span-2 h-64 bg-surface-dim relative overflow-hidden group">
            <img 
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="bg-primary p-4 text-white flex flex-col items-center shadow-xl">
        ...
        <div className="lg:col-span-5 bg-surface-container-low p-10">
          <h2 className="text-3xl font-black tracking-tight text-primary mb-2">QUICK MESSAGE</h2>
          <p className="text-on-surface-variant text-sm mb-10">Our technical team will respond within 2 business hours.</p>
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button disabled={loading} className="w-full bg-primary text-white font-bold py-5 hover:bg-primary-container transition-colors flex items-center justify-center gap-3 disabled:opacity-70" type="submit">
